...
def empty_crate(user_name: str, crate_name: str, ddb):
    """ Remove all videos from crate and commit to DDB. """
    response = ddb.update_item(
            TableName='Crates',
            Key={
                'UserName': {'S': user_name},
                'CrateName': {'S': crate_name}
                },
...
def main():
    ...
    #empty_crate(DEFAULT_DUMMY_USER, DEFAULT_CRATE_NAME, table)
    empty_crate(DEFAULT_DUMMY_USER, DEFAULT_CRATE_NAME, ddb)
#
