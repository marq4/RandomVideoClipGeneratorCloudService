...
def get_default_crate_pairs_from_ddb():
    """ Return list of dictionaries read from DynamoDB. """
...
def main():
    """ Read Default DDB Table 'Crates' & default crate, generate XML. """
    os.environ['AWS_PROFILE'] = "default"
    os.environ['AWS_DEFAULT_REGION'] = 'us-east-2'
    pairs = get_default_crate_pairs_from_ddb()
    xml = generate_playlist(pairs)
    print("<p>The playlist for VLC has been generated.</p>")
